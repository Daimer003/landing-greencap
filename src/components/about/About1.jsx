...
function About1(props) {
    ...
    const [dataBlock] = useState(
        {
            heading: 'TU VIAJE AL METAVERSO INICIA CON NOSOTROS',
            desc: 'Capital Green transforma la forma en que las organizaciones interactúan con el mundo digital. Como arquitectos del metaverso, potenciamos tu presencia online, desbloqueamos nuevas oportunidades de negocio y construimos experiencias inmersivas para tus clientes. Tu éxito en el metaverso comienza aquí. Conoce las ventajas del metaverso:'
    ...
    const [dataCounter] = useState([
        {
            id: 1,
            title: 'Metaverso Proyección 2024',
            number: '$800.000',
        },
        {
            id: 4,
            title: 'Usuarios activos en el mundo',
            number: '+400 mm',
        },
