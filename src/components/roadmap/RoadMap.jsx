...
function RoadMap(props) {
    ...
    const { data } = props;
    return (
        <section className="tf-section section-roadmap3 section-bg-1" id='NUESTRO PROCESO'>
            <div className="container-fluid">
                <div className="row">
                    <div className="tf-heading mb60 wow fadeInUp">
                        <h2 className="heading" >NUESTRO PROCESO</h2>
                    </div>
                                            ...
                                            <div className="roadmap-box">
                                                <div className="shape-circle">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="60" height="176" viewBox="0 0 60 176" fill="none">
                                                        ...
                                                        <circle cx="30" cy="30" r="30" fill="#84C14D" className="fill-1" fillOpacity="0.2" />
                                                        <circle cx="30" cy="30" r="15" fill="#84C14D" className="fill-2" />
                                                    </svg>
                                                </div>
